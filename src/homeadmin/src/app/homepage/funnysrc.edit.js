define([], function () {
    var diName = 'FunnysrcEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.funnysrc', '$log', 'dpDialog',FunnysrcEditCtrl]);
            return mod;
        }
    };

    function FunnysrcEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
