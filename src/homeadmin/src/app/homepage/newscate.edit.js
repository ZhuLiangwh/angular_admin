define([], function () {
    var diName = 'NewscateEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.newscate', '$log', 'dpDialog',NewscateEditCtrl]);
            return mod;
        }
    };

    function NewscateEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
