define([], function () {
    var diName = 'PictureCateEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.pictureCate', '$log', 'dpDialog',PictureCateEditCtrl]);
            return mod;
        }
    };

    function PictureCateEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
