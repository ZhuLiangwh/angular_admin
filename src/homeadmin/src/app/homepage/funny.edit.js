define([], function () {
    var diName = 'FunnyEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.funny', '$log', 'dpDialog',FunnyEditCtrl]);
            return mod;
        }
    };

    function FunnyEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
