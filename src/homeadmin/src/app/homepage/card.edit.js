define([], function () {
    var diName = 'CardEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.card', '$log', 'dpDialog',CardEditCtrl]);
            return mod;
        }
    };

    function CardEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
