define([], function () {
    var diName = 'GraySwitchEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.graySwitch', '$log', 'dpDialog',GraySwitchEditCtrl]);
            return mod;
        }
    };

    function GraySwitchEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
