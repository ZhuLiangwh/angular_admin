define([], function () {
    var diName = 'HotwordEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.hotword', '$log', 'dpDialog',HotwordEditCtrl]);
            return mod;
        }
    };

    function HotwordEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
