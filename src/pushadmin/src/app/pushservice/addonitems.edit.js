define([], function () {
    var diName = 'AddonitemsEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope', 'apiService','$state', '$window', '$location', 'ds.addonitems', '$log','dpDialog', AddonitemsEditCtrl]);
            return mod;
        }
    };

    function AddonitemsEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/addonitems/check_unique');
        }
