define(['common/utils/date'], function (dateUtil) {
    var diName = 'AmazonurlEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.amazonurl', '$log', 'dpDialog',AmazonurlEditCtrl]);
            return mod;
        }
    };

    function AmazonurlEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
        ...
        $scope.save = function () {
            ...
            console.log($scope.entity.urlitem.order)
        };
