define([], function () {
    var diName = 'SpeeddialEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope', 'apiService','$state', '$window', '$location', 'ds.speeddial', '$log','dpDialog', SpeeddialEditCtrl]);
            return mod;
        }
    };

    function SpeeddialEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/speeddial/check_unique');
        }
