define([], function () {
    var diName = 'UrlredirectEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', 
                '$location', 'ds.urlredirect', '$log', 'dpDialog',UrlredirectEditCtrl]);
            return mod;
        }
    };

    function UrlredirectEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
