define([], function () {
    var diName = 'DetectmoduleEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.detectmodule', '$log', 'dpDialog',DetectmoduleEditCtrl]);
            return mod;
        }
    };

    function DetectmoduleEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
