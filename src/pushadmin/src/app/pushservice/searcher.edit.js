define([], function () {
    var diName = 'SearcherEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.searcher', '$log','dpDialog', SearcherEditCtrl]);
            return mod;
        }
    };

    function SearcherEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/searcher/check_unique');
        }
