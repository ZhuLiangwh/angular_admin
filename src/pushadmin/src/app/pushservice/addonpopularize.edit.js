define([], function () {
    var diName = 'AddonpopularizeEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.addonpopularize', '$log', 'dpDialog',AddonpopularizeEditCtrl]);
            return mod;
        }
    };

    function AddonpopularizeEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log, dpDialog) {
        ...
        $scope.popUp = function(method, moduleName, modelName,label,index,params,single){
            ...
            dpDialog.loadIframe({
                ...
                from:'pushservice_addonpopularize'
            });
        };
