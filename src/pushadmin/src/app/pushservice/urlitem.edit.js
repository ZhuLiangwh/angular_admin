define([], function () {
    var diName = 'UrlitemEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.urlitem', '$log', 'dpDialog',UrlitemEditCtrl]);
            return mod;
        }
    };

    function UrlitemEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
