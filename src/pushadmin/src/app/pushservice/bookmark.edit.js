define([], function () {
    var diName = 'BookmarkEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope', 'apiService','$state', '$window', '$location', 'ds.bookmark', '$log','dpDialog', BookmarkEditCtrl]);
            return mod;
        }
    };

    function BookmarkEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/bookmark/check_unique');
        }
