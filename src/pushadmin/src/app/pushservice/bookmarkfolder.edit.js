define([], function () {
    var diName = 'BookmarkfolderEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.bookmarkfolder', '$log','dpDialog', BookmarkfolderEditCtrl]);
            return mod;
        }
    };

    function BookmarkfolderEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/bookmarkfolder/check_unique');
        }
        ...
        $scope.popUp = function(method, moduleName, modelName,label,index,params,single){
            ...
            dpDialog.loadIframe({
                ...
                from:'pushservice_bookmarkfolder'
            });
        };
