define([], function () {
    var diName = 'iUrlitemEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.iurlitem', '$log', 'dpDialog',iUrlitemEditCtrl]);
            return mod;
        }
    };

    function iUrlitemEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
