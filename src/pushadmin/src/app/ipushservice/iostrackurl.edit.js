define(['common/utils/date'], function (dateUtil) {
    var diName = 'IostrackurlEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.iostrackurl', '$log', 'dpDialog',IostrackurlEditCtrl]);
            return mod;
        }
    };

    function IostrackurlEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
        ...
        //select acitce
        $scope.action_type = [
            {value:true,name:'开启Track URL'},
            {value:false,name:'关闭Track URL'}
        ];
