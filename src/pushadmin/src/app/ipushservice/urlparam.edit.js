define([], function () {
    var diName = 'UrlparamEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.urlparam', '$log', 'dpDialog',UrlparamEditCtrl]);
            return mod;
        }
    };

    function UrlparamEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
