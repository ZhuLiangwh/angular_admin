define([], function () {
    var diName = 'UrloptionEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope', 'apiService','$state', '$window', '$location', 'ds.iurloption', '$log','dpDialog', UrloptionEditCtrl]);
            return mod;
        }
    };

    function UrloptionEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/iurloption/check_unique');
        }
