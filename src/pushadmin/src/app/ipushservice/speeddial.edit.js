define([], function () {
    var diName = 'iSpeeddialEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope', 'apiService','$state', '$window', '$location', 'ds.ispeeddial', '$log','dpDialog', iSpeeddialEditCtrl]);
            return mod;
        }
    };

    function iSpeeddialEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/ispeeddial/check_unique');
        }
        ...
        function addCheckunique(){
            action = 'add';
            return DS['addCheckunique']({title: $scope.entity.title, method:action, id: $scope.entity.id, url: $scope.entity.url})
                .then(function(data){
