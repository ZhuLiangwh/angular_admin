define([], function () {
    ...
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope', 'apiService','$state', '$window', '$location', 'ds.pcbookmark', '$log','dpDialog', pcBookmarkEditCtrl]);
            return mod;
        }
    };

    function pcBookmarkEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/pcbookmark/check_unique');
        }
