define([], function () {
    var diName = 'IntervalfuncEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.intervalfunc', '$log', 'dpDialog',IntervalfuncEditCtrl]);
            return mod;
        }
    };

    function IntervalfuncEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log, dpDialog) {
