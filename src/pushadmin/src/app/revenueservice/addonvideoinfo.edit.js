define([], function () {
    var diName = 'AddonvideoinfoEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.addonvideoinfo', '$log', 'dpDialog',AddonvideoinfoEditCtrl]);
            return mod;
        }
    };

    function AddonvideoinfoEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log, dpDialog) {
        ...
        $scope.popUp = function(method, moduleName, modelName,label,index,params,single){
            ...
            dpDialog.loadIframe({
                ...
                from:'revenueservice_addonvideoinfo'
            });
        };
