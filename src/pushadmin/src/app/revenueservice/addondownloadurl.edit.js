define([], function () {
    var diName = 'AddondownloadurlEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.addondownloadurl', '$log', 'dpDialog',AddondownloadurlEditCtrl]);
            return mod;
        }
    };

    function AddondownloadurlEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log, dpDialog) {
