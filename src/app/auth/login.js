define([], function () {
    ...
    return {
        __register__: function (mod) {
            mod.controller(diName, ['authenticator', '$rootScope', '$scope', '$q', 'logger', '$state', 'DEFAULT_STATE','apiService', LoginCtrl]);
        }
    };
    ...
    function LoginCtrl(authenticator, $rootScope, $scope, $q, logger, $state, DEFAULT_STATE,apiService) {
        ...
        //    apiService.editENV(vm.value.ENV);
        //};
