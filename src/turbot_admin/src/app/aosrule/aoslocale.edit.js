define([], function() {
  var diName = 'AoslocaleEditCtrl';
  return {
    __register__: function(mod) {
      mod.controller(diName, ['$rootScope', '$scope', '$state', '$window', '$location', 'ds.aoslocale', '$log', AoslocaleEditCtrl]);
      return mod;
    }
  };

  function AoslocaleEditCtrl($rootScope, $scope, $state, $window, $location, DS, $log) {
