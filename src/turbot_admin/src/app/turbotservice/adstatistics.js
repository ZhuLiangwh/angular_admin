define([
    ...
    var diName = 'AdstatisticsCtrl';
    return {
        __register__: function(mod) {
            mod.controller(diName, ['$scope','$state' ,'logger', 'ds.adstatistics', 'apiService', AdstatisticsCtrl]);
            return mod;
        }
    };

    function AdstatisticsCtrl($scope,$state ,logger, DS, apiService) {
