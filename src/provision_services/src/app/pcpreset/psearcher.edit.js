define([], function () {
    var diName = 'PsearcherEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.psearcher', '$log','dpDialog', PsearcherEditCtrl]);
            return mod;
        }
    };

    function PsearcherEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/psearcher/check_unique');
        }
