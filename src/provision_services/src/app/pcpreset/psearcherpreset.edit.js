define([], function () {
    var diName = 'PsearcherpresetEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.psearcherpreset', '$log', 'dpDialog',PsearcherpresetEditCtrl]);
            return mod;
        }
    };

    function PsearcherpresetEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
