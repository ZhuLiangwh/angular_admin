define([], function () {
    var diName = 'PCbookmarkfolderEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', 'apiService','$scope', '$state', '$window', '$location', 'ds.pbookmarkfolder', '$log', 'dpDialog' , PCbookmarkfolderEditCtrl]);
            return mod;
        }
    };

    function PCbookmarkfolderEditCtrl($rootScope, apiService,$scope, $state, $window, $location, DS, $log, dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/pbookmarkfolder/check_unique');
        }
