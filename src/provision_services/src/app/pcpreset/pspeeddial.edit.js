define([], function () {
    var diName = 'PspeeddialEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', 'apiService','$scope', '$state', '$window', '$location', 'ds.pspeeddial', '$log','dpDialog', PspeeddialEditCtrl]);
            return mod;
        }
    };

    function PspeeddialEditCtrl($rootScope, apiService,$scope, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/pspeeddial/check_unique');
        }
