define(['common/utils/klass', 'common/utils/url'], function(klass, UrlUtil) {
  ...
  proto._load = function(url, httpConfig, isAbs) {
    return this._makeHttpRequestPromise(this, 'GET', this._getApiUrl(url, isAbs), httpConfig);
  };
  proto._update = function(url, httpConfig) {
    return this._makeHttpRequestPromise(this, 'POST', this._getApiUrl(url), httpConfig);
  };
  proto._getApiUrl = function(dsUrl, isAbs) {
    return isAbs ? dsUrl : this.apiService.getApiUrl(UrlUtil.prefixSlash(dsUrl));
  };
