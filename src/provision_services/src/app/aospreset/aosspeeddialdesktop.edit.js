define([], function () {
    var diName = 'AosspeeddialdesktopEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', 'apiService','$scope', '$state', '$window', '$location', 'ds.aosspeeddialdesktop', '$log','dpDialog', AosspeeddialdesktopEditCtrl]);
            return mod;
        }
    };

    function AosspeeddialdesktopEditCtrl($rootScope,apiService, $scope, $state, $window, $location, DS, $log, dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/aosspeeddialdesktop/check_unique');
        }
        ...
        $scope.popUp = function(method, moduleName, modelName,label,index,params,single){
            ...
            dpDialog.loadIframe({
                ...
                from:'aospreset_aosspeeddialdesktop'
            });
        };
