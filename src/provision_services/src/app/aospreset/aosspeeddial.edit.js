define([], function () {
    var diName = 'AosspeeddialEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope', 'apiService','$state', '$window', '$location', 'ds.aosspeeddial', '$log','dpDialog', AosspeeddialEditCtrl]);
            return mod;
        }
    };

    function AosspeeddialEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/aosspeeddial/check_unique');
        }
