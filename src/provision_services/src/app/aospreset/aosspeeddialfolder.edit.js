define([], function () {
    var diName = 'AosspeeddialfolderEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.aosspeeddialfolder', '$log','dpDialog', AosspeeddialfolderEditCtrl]);
            return mod;
        }
    };

    function AosspeeddialfolderEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/aosspeeddialfolder/check_unique');
        }
        ...
        $scope.popUp = function(method, moduleName, modelName,label,index,params,single){
            ...
            dpDialog.loadIframe({
                ...
                from:'aospreset_aosspeeddialfolder'
            });
        };
