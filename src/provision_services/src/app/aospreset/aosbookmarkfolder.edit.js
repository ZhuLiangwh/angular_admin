define([], function () {
    var diName = 'AosbookmarkfolderEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', 'apiService','$scope', '$state', '$window', '$location', 'ds.aosbookmarkfolder', '$log', 'dpDialog' , AosbookmarkfolderEditCtrl]);
            return mod;
        }
    };

    function AosbookmarkfolderEditCtrl($rootScope, apiService,$scope, $state, $window, $location, DS, $log, dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/aosbookmarkfolder/check_unique');
        }
        ...
        $scope.popUp = function(method, moduleName, modelName,label,index,params,single){
            ...
            dpDialog.loadIframe({
                ...
                from:'aospreset_aosbookmarkfolder'
            });
        };
