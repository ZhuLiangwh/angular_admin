define([], function () {
    var diName = 'AosrecommendshareEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope', 'apiService','$state','apiService', '$window', '$location', 'ds.aosrecommendshare', '$log','dpDialog', AosrecommendshareEditCtrl]);
            return mod;
        }
    };

    function AosrecommendshareEditCtrl($rootScope, $scope,apiService, $state,apiService, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/aosrecommendshare/check_unique');
        }
        ...
        $scope.popUp = function(method, moduleName, modelName,label,index,params,single){
            ...
            dpDialog.loadIframe({
                ...
                from:'aospreset_aosrecommendshare'
            });
        };
