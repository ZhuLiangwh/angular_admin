define([], function () {
    var diName = 'AosspeeddialscreenEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope', 'apiService','$state', '$window', '$location', 'ds.aosspeeddialscreen', '$log','dpDialog', AosspeeddialscreenEditCtrl]);
            return mod;
        }
    };

    function AosspeeddialscreenEditCtrl($rootScope, $scope, apiService,$state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/aosspeeddialscreen/check_unique');
        }
        ...
        $scope.popUp = function(method, moduleName, modelName,label,index,params,single){
            ...
            dpDialog.loadIframe({
                ...
                from:'aospreset_aosspeeddialscreen'
            });
        };
