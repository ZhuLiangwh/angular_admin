define([], function () {
    var diName = 'AostemplateshareEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope', '$state','apiService', '$window', '$location', 'ds.aostemplateshare', '$log','dpDialog', AostemplateshareEditCtrl]);
            return mod;
        }
    };

    function AostemplateshareEditCtrl($rootScope, $scope, $state,apiService, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/aostemplateshare/check_unique');
        }
