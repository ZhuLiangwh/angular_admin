define([], function () {
    var diName = 'AospredataEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state','$modal', '$window', '$location', 'ds.aospredata', '$log', 'dpDialog',AospredataEditCtrl]);
            return mod;
        }
    };

    function AospredataEditCtrl($rootScope, $scope,apiService, $state,$modal, $window, $location, DS, $log, dpDialog) {
