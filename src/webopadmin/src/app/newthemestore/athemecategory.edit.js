define([], function () {
    var diName = 'AthemecategoryEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.athemecategory', '$log','dpDialog', AthemecategoryEditCtrl]);
            return mod;
        }
    };

    function AthemecategoryEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/athemecategory/check_unique');
        }
        ...
        $scope.popUp = function(method, moduleName, modelName,label,index,params,single){
            ...
            dpDialog.loadIframe({
                ...
                from:'newthemestore_athemecategory'
            });
        };
