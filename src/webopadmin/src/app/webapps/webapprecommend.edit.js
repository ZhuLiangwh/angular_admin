define([], function () {
    var diName = 'WebapprecommendEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.webapprecommend', '$log','dpDialog', WebapprecommendEditCtrl]);
            return mod;
        }
    };

    function WebapprecommendEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/webapprecommend/check_unique');
        }
