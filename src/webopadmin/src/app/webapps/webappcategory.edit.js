define([], function () {
    var diName = 'WebappcategoryEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.webappcategory', '$log','dpDialog', WebappcategoryEditCtrl]);
            return mod;
        }
    };

    function WebappcategoryEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/webappcategory/check_unique');
        }
