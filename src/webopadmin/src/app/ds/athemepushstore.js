define(['./DataSource'], function(DataSource) {
  var basePath = 'athemepushstore';

  var AthemepushstoreDS = DataSource.ext({
    ...
    update: function(data) {
      return this._update(basePath + '/update/'+ data.id,{
        data: data
      });
    },
  ...
  return {
    __register__: function(mod) {
      mod.service('ds.athemepushstore', AthemepushstoreDS);
      return mod;
    }
  };
})
