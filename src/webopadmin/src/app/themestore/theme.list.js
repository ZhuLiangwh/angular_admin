define(['common/utils/date', 'common/utils/dataConverter','text!layouts/confirm-dialog.html','text!layouts/alert-dialog.html','common/utils/url'], function (dateUtil, dataConverter,confirmDialogTpl,alertDialogTpl,url) {
    ...
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$scope', '$window', '$state', '$filter','cache','$location', '$modal', 'ngTableParams', 'ds.theme', 'logger', 'apiService','dpErrorHandler','dpDialog', 'PER_PAGE', ThemeListCtrl]);
            return mod;
        }
    };

    function ThemeListCtrl($scope, $window, $state, $filter,cache, $location, $modal, ngTableParams, DS, logger, apiService, dpErrorHandler,dpDialog,PER_PAGE) {
        ...
        $scope.addTheme = function () {
            $state.go('themestore.add-theme');
        };

        $scope.ViewDetail = function (item) {
            $state.go('themestore.edit-theme',{id:item.id});
        };
