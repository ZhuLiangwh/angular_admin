define([], function () {
    var diName = 'ApplistEditCtrl';
    return {
        __register__: function (mod) {
            mod.controller(diName, ['$rootScope', '$scope','apiService', '$state', '$window', '$location', 'ds.applist', '$log','dpDialog', ApplistEditCtrl]);
            return mod;
        }
    };

    function ApplistEditCtrl($rootScope, $scope,apiService, $state, $window, $location, DS, $log,dpDialog) {
        ...
        $scope.getCheckSortUrl = function() {
            return apiService.getApiUrl('/applist/check_unique');
        }
